        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_detalle_orden_ordenes_OrdenId",
                        column: x => x.OrdenId,
                        principalTable: "ordenes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_detalle_orden_productos_ProductoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Prendas de vestir y complementos", "Ropa y Accesorios" },
                    { 2, "Dispositivos electrónicos y tecnología", "Tecnología" },
                    { 3, "Artículos para el hogar y muebles", "Hogar y Muebles" },
                    { 4, "Equipamiento y ropa deportiva", "Deportes" },
                    { 5, "Libros de todo tipo", "Libros" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Administrador completo del sistema", "administrador" },
                    { 2, "Usuario que puede vender y comprar", "usuario_sistema" },
                    { 3, "Usuario que solo puede comprar", "externo" }
                });
